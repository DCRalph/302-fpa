  ...
  update: protectedProcedure
    .input(
      z.object({
        ...
        professionalYears: z.number().optional().nullable(),
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const updated = await ctx.db.user.update({
        ...
        data: {
          ...
          professionalPosition: input.professionalPosition ?? undefined,
          professionalYears: input.professionalYears ?? undefined,
